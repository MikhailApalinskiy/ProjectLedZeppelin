...
/**
 * Servlet responsible for displaying and managing user notifications.
 *
 * <p>Provides listing, marking notifications as read, and clearing all notifications.
 * Requires the user to be authenticated.</p>
 */
public class NotificationsServlet extends HttpServlet {
    ...
    /**
     * Initializes {@link NotificationRepository} from the servlet context.
     */
    @Override
    public void init() {
     ...
     *
     * <p>Loads notifications with pagination parameters (limit, offset)
     * and forwards to {@link WebConst.Jsp#NOTIFICATIONS}.</p>
     *
    ...
    /**
     * Handles notification actions: mark as read, mark all, or clear all.
     *
     * <p>Redirects back to {@link WebConst.Path#NOTIFICATIONS} after each operation.</p>
     *
     * @param req  HTTP request
     * @param resp HTTP response
     * @throws IOException on redirect or repository error
     */
    @Override
